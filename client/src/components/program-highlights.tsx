    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#003865] mb-4">Program Highlights</h2>
          <p className="text-xl text-[#111111]">Fast-track your career with our comprehensive MBA program</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((highlight, index) => (
            <div key={index} className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#003865] mb-2">{highlight.title}</h3>
        ...
        <div className="mt-12 bg-gradient-to-r from-[#003865] to-[#001a33] rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-lg text-white/90">Qualify for extended Optional Practical Training (OPT) and enhance your career prospects in the U.S.</p>
        </div>
      </div>
    </section>
  );
