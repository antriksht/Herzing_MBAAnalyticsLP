    ...
    <section className="py-16 bg-neutral-gray">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-primary-blue mb-4">Herzing Means Support</h2>
          <p className="text-xl text-gray-600">We're with you every step of the way</p>
        </div>
          ...
          {supports.map((support, index) => (
            <div key={index} className="bg-white rounded-xl p-8 shadow-lg">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-primary-blue mb-2">{support.title}</h3>
